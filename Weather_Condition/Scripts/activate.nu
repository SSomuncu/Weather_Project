...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\senel\OneDrive\Desktop\Python_Kursu_Araçları\PyCharm_Projects\Weather_Condition'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\senel\OneDrive\Desktop\Python_Kursu_Araçları\PyCharm_Projects\Weather_Condition\Scripts\deactivate.nu'
